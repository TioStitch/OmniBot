...
public class OmniPanel extends JPanel {
    ...
    private static ImageIcon backdraw = new ImageIcon(OmniPanel.class.getResource(main.getOmniState().getBackgroundLocale()));
    private Timer timer;
    ...
    public void startDashTick() {
        backdraw = new ImageIcon(OmniPanel.class.getResource(main.getOmniState().getBackgroundLocale()));
    ...
    public void paint(Graphics g) {
        ...
        if (main.getOmniState() == OmniState.CONFIG_BOT) {
